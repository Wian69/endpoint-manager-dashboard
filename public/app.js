        ...
        card.innerHTML = `
            <div>
                ...
                <div class="device-info">
                    ...
                    <p><strong>Network:</strong> ${escapeHtml(device.network_name || 'Unknown')}</p>
                    <p><strong>Location:</strong> ${escapeHtml(device.location || 'Unknown')}</p>
...
function openDeviceModal(hostname) {
    ...
    let bodyHtml = `<div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 1rem;">
        ...
        <button class="btn-action danger" onclick="deleteDevice('${device.hostname}')">
